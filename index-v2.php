                                                            ...
                                                            <?php foreach ($elem["frutta"] as $frutto): ?>
                                                                <div class="col-md-4">
                                                                    <?php if(isset($fruits[$frutto])): ?>
                                                                        <div class="slide-elem" style="background-image: url(<?= $imageBaseUrl . $fruits[$frutto]["image"] ?>);">
                                                                    <?php else: ?>
                                                                        <div class="slide-elem" style="background-image: url(https://via.placeholder.com/150x120);">
                                                                    <?php endif; ?>
                                                            ...
                                                            <?php foreach ($elem["verdura"] as $verdura): ?>
                                                                <div class="col-md-4">
                                                                    <?php if(isset($vegetables[$verdura])): ?>
                                                                        <div class="slide-elem" style="background-image: url(<?= $imageBaseUrl . $vegetables[$verdura]["image"] ?>);">
                                                                    <?php else: ?>
                                                                        <div class="slide-elem" style="background-image: url(https://via.placeholder.com/150x120);">
                                                                    <?php endif; ?>
                                                                            <div class="slide-elem-text">
